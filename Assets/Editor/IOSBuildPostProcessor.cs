...
/// - AppTrackingTransparency framework linking (fixes ATTrackingManager errors)
/// - StoreKit framework linking (required for IAP)
...
/// This prevents duplicate class warnings and ensures ads and IAP work correctly.
/// </summary>
public class IOSBuildPostProcessor
{
    ...
    public static void OnPostProcessBuild(BuildTarget buildTarget, string pathToBuiltProject)
    {
        ...
        // 2. Configure Swift Library Embedding & Add Required Frameworks
        ConfigureSwiftLibrariesAndFrameworks(pathToBuiltProject);
    ...
    private static void ConfigureSwiftLibrariesAndFrameworks(string pathToBuiltProject)
    {
        ...
        // Add AppTrackingTransparency framework - Required for ATTrackingManager
        // This fixes the "Undefined symbol: _OBJC_CLASS_$_ATTrackingManager" error
        project.AddBuildProperty(frameworkTarget, "OTHER_LDFLAGS", "-framework AppTrackingTransparency");
        UnityEngine.Debug.Log("✅ Added AppTrackingTransparency framework");

        // Add StoreKit framework - Required for In-App Purchases
        project.AddBuildProperty(frameworkTarget, "OTHER_LDFLAGS", "-framework StoreKit");
        UnityEngine.Debug.Log("✅ Added StoreKit framework for IAP");

        project.WriteToFile(projectPath);
        UnityEngine.Debug.Log("✅ Configured Swift library embedding and frameworks");
    }
