...
public class NakamaConnection : ScriptableObject
{
    ...
    public async Task Connect()
    {
        try
        {
            ...
            Client = new Client("http", "3.21.102.93", 7350, "dominosasdsocketcvxkey", UnityWebRequestAdapter.Instance);
        ...
        {
            Debug.LogError("NakamaConnection.Connect exception: " + ex);
            ...
            if (gamePlayWaitingPopUp != null)
                gamePlayWaitingPopUp.SetData("Failed to connect. Please check your connection.", false);
        }
    }
